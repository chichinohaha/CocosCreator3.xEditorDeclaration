import { AssetInfo, QueryAssetsOption, AssetOperationOption, AssetDBOptions } from './public';
...
declare global {
    export module Editor {
        export module Message { 
             ...
             * @param options 可选项
             */
            export function request(name:'asset-db', message:'create-asset',file:string,options:AssetOperationOption): Promise<boolean>;
        }
    }
